...
class Game:
    ...
    def start(self):
        ...
        while start:
            ...
            tournement_text = FONT.render("press t to play tournement", True, 'yellow')
            self.win.fill("black")
            ...
            self.win.blit(tournement_text, (WIDTH // 2 - tournement_text.get_width() // 2,
                                        HEIGHT // 3 - tournement_text.get_height() // 2 + singleplayer_text.get_height() + multiplayer_text.get_height() +
                                        start_text.get_height()))
            pygame.display.update()

    def tournement_check(self, ai, player, ball):
    ...
    def set_level(self, ai):
            ...
            if self.choice == 1 or self.choice == 3:
                while run:
                    ...
                    selct_text = FONT.render("Seclect Level", True, "red")
                    beginner_text = FONT.render("a- Beginner", True, "white")
                    amateur_text = FONT.render("b- Ammateur", True, "white")
                    normal_text = FONT.render("c- Normal", True, "white")
                    professionel_text = FONT.render("d- Professionel", True, "white")
                    top_player_text = FONT.render("e- Top Player", True, "white")
                    self.win.fill("black")
                    self.win.blit(selct_text, (WIDTH // 2 - selct_text.get_width() // 2, HEIGHT // 7 - selct_text.get_height()))
                    ...
                    self.win.blit(professionel_text, (WIDTH // 2 - professionel_text.get_width() // 2, HEIGHT * 5 // 7 - professionel_text.get_height()))
